...
public class BookLater extends Fragment implements View.OnClickListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    View view;
    Button get_quote;
    String pickup_address, dropoff_address,booking_datetime,pickuppoint_name, dropoffpoint_name;
    LatLng pickup_latlng, dropoff_latlng;
    Double pickup_lat,pickup_lng, dropoff_lat, dropoff_lng;
    DatePicker datePicker;
    TimePicker timePicker;
    //    SupportPlaceAutocompleteFragment pickup_point,dropoff_point;
    LinearLayout pickup_container,dropoff_container;
