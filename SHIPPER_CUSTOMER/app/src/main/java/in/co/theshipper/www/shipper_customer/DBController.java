...
public class DBController  extends SQLiteOpenHelper {
    ...
    {
        Fn.logD("createTable","createTable");
    ...
    public void deleteTable(int table_no) {
        Fn.logD("deleteTable","deleteTable");
        SQLiteDatabase database = this.getWritableDatabase();
        if (table_no == 0) {
    ...
    public void getAll() throws ParseException {
        ...
        // cursor =database.rawQuery("select count(_ID) from view_pricing",null);
