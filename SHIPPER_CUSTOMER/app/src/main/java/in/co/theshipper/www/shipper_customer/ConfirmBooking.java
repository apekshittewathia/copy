...
public class ConfirmBooking extends Fragment implements View.OnClickListener{
    ...
    String truck_name="NOT AVAILABLE";
    DateFormat time,date;
    Date d;
    int active=0;
    DBController controller;
    double base_fare_min,base_fare_max,total_fare_min,total_fare_max,distance_fare=0;
    protected String TAG = ConfirmBooking.class.getName();
    View view;
    String actual_booking_datetime, pickup_address,dropoff_address,pickuppoint_name,dropoffpoint_name,booking_datetime,selected_vehicle,journey_distance,journey_duration;
    TextView booking_detail, pickup_point_view,dropoff_point_view,vehicle_name_view,booking_datetime_view,total_distance_view,total_time_view,total_fare_view;
    protected RequestQueue requestQueue;
    Button confirm_boking;
...
//        hashMap.put("user_token","32131232133123");
        HashMap<String,String> hashMap = new HashMap<String,String>();
...
//            int i = Integer.parseInt(selected_vehicle);
            ...
            String query1="SELECT "+controller.BASE_FARE+", "+controller.TRANSIT_CHARGE+" FROM "+controller.TABLE_VIEW_BASE_FARE+" WHERE "
                    +controller.VEHICLETYPE_ID+"="+ selected_vehicle;
            String query2 = "SELECT "+controller.FROM_DISTANCE+", "+controller.TO_DISTANCE+", "+controller.PRICE_KM+" FROM "+controller.TABLE_VIEW_PRICING+" WHERE "
                    +controller.VEHICLETYPE_ID+"="+selected_vehicle+" ORDER BY "+controller.TO_DISTANCE+" ASC";
...
//                System.out.println("Time: " + time.format(d));
            ...
            booking_datetime_view.setText(actual_booking_datetime);
