    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   profile_pic = (ImageView) findViewById(R.id.profile_pic);
        ...
        * */
        ...
        //System.out.println(JsonWriter.formatJson((json_string).toString()))
...
//        String rece = Fn.getPreference(this,"user_token");
...
//        String method = "edit_customer_profile";
//        BackgroundTask backgroundTask = new BackgroundTask(this);
//        backgroundTask.execute(method,username,useremail,useraddress);
        }
        else{
